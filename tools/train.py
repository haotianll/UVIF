...
def merge_args(cfg, args):
    ...
    # NEW
    elif cfg.get('work_root', None) is not None:
        # NEW: use work_root as root work dir
        cfg.work_dir = osp.join(cfg.work_root,
    ...
    if args.data_root is not None:
        for field in ['train_dataloader', 'val_dataloader', 'test_dataloader']:
            if cfg[field]['dataset'].get('datasets') is not None:
                for i in range(len(cfg[field]['dataset']['datasets'])):
                    cfg[field]['dataset']['datasets'][i].data_root = args.data_root
            else:
                cfg[field]['dataset']['data_root'] = args.data_root
    # END NEW
